...
import prettyBytes from "./PrettyBytes/index.js";
// import { SmoothieChart, TimeSeries } from "./Smoothie.js";
// import * as Charts from "./Smoothie.js";
...
export class Network {
    ...
    updateInfo() {
        ...
        if (window.mods.netstat.offline || window.mods.netstat.iface === null) {
            ...
            this.outer.setAttribute("class", "offline");
            return; } 
        else {
            this.outer.setAttribute("class", "");
    ...
    chart(wrapper) {
        ...
        let [root, outer, inner] = HTML.chain(wrapper, `div::/div::`); 
        outer.id = 'mod_conninfo'
        inner.id = 'mod_conninfo_innercontainer'
        let [h1,h2,c1,c2,h3] = HTML.ladder(inner,`h1::NETWORK TRAFFIC/h2::TOTAL/canvas::?/canvas::?/h3::OFFLINE`);
        c1.id = "mod_conninfo_canvas_top"
        c2.id = "mod_conninfo_canvas_bottom"
        let [, i1] = HTML.chain(h1, `i::UP \\ DOWN, MB\\S`); 
        let [, i2] = HTML.chain(h2, `i::0B OUT, 0B IN`); 
        this.outer = outer
        this.inner = inner
        this.current = i1
        this.total = i2
    ...
    constructor(terminal, width, height) {
        ...
        this.series = [new TimeSeries(), new TimeSeries()]; // Create chart
        ...
        this.charts[0].streamTo(this.c1, 1000);
        this.charts[1].streamTo(this.c2, 1000);
        this.updateInfo(); // Init updater
