class UpdateChecker {
    constructor() {
        ...
        let remote = import("@electron/remote");
                    ...
                    try {
                        ...
                        if (release.tag_name.slice(1) === current) {
                            ...
                            new Modal({
                                ...
                                message: `eDEX-UI <strong>${release.tag_name}</strong> is now available.<br/>Head over to <a href="#" onclick="import('electron').shell.openExternal('${release.html_url}')">github.com</a> to download the latest version.`
                            });
