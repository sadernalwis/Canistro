...
!function a(b, c, d) {
    ...
    return e; }
        ({  1:  [ function(a) { Quadtree2 = a("./src/quadtree2"); }, { "./src/quadtree2": 3 } ],
            2:  [ function(a, b) {
                    !function c(a, d, e) {
                        function f(a, b) {
                        ...
                        var g = function(a) { return "[object Array]" === Object.prototype.toString.call(a); };
                        f.prototype = {
                            change: function(a) {
                            ...
                            zero: function() { return this.set(0, 0); },
                            clone: function() { return new this.constructor(this.x, this.y); },
                            negate: function(a) { return a ? new this.constructor(-this.x, -this.y) : this.set(-this.x, -this.y); },
                            add: function(a, b) { return b ? new this.constructor(this.x + a.x, this.y + a.y) : (this.x += a.x, this.y += a.y, this.change()); },
                            subtract: function(a, b) { return b ? new this.constructor(this.x - a.x, this.y - a.y) : (this.x -= a.x, this.y -= a.y, this.change()); },
                            ...
                            equal: function(a, b) { return b === e && (b = a.y, a = a.x), f.clean(a) === this.x && f.clean(b) === this.y; },
                            abs: function(a) {
                            ...
                            lerp: function(a, b) { return this.add(a.subtract(this, !0).multiply(b), !0); },
                            skew: function() { return new this.constructor(-this.y, this.x); },
                            dot: function(a) { return f.clean(this.x * a.x + a.y * this.y); },
                            perpDot: function(a) { return f.clean(this.x * a.y - this.y * a.x); },
                            angleTo: function(a) { return Math.atan2(this.perpDot(a), this.dot(a)); },
                            divide: function(a, b) {
                                var c, d;
                            ...
                            isPointOnLine: function(a, b) { return (a.y - this.y) * (a.x - b.x) === (a.y - b.y) * (a.x - this.x); },
                            toArray: function() { return [ this.x, this.y ]; },
                            fromArray: function(a) { return this.set(a[0], a[1]); },
                            toJSON: function() { return { x: this.x, y: this.y }; },
                            toString: function() { return "(" + this.x + ", " + this.y + ")"; },
                            constructor: f }, 
                        f.fromArray = function(a, b) { return new (b || f)(a[0], a[1]); }, 
                        f.precision = d || 8;
                        ...
                        f.inject = c, a || (f.fast = c(function(a) { return a; }), "undefined" != typeof b && "object" == typeof b.exports ? b.exports = f : window.Vec2 = window.Vec2 || f),  f; }(); }, {} ],
            3:  [ function(a, b) {
                    ...
                    c = function(a, b, c) {
                        ...
                        j = new f(), k = { p: "pos_", r: "rad_", id: "id_" }, 
                        ...
                        this.setSize(a), this.setQuadrantObjectsLimit(b), this.setQuadrantLevelLimit(c); }, b.exports = c; },  { "./quadtree2helper": 4, "./quadtree2quadrant": 5, "./quadtree2validator": 6, vec2: 2 } ],
            4: [ function(a, b) {
                    var c = {
                        fnName: function(a) {
                            var b = a.toString();
                    ...
                    b.exports = c; }, {} ],
            5: [ function(a, b) {
                var c = function(a, b, c, d) { this.leftTop_ = a.clone(), this.children_ = [], this.objects_ = {}, this.objectCount_ = 0, this.id_ = c || 0,  this.parent_ = d, this.refactoring_ = !1, this.setSize(b); };
                c.prototype = {
                    setSize: function(a) {
                    ...
                    makeChildren: function(a) { return this.children_.length > 0 ? !1 : (this.children_.push(new c(this.leftTop_, this.rad_, a++, this), new c(this.topMid_, this.rad_, a++, this), new c(this.leftMid_, this.rad_, a++, this), new c(this.center_, this.rad_, a++, this)), a); },
                    looseChildren: function() { this.children_ = []; },
                    addObjects: function(a) {
                        var b;
                        for (b in a) this.addObject(b, a[b]); },
                    addObject: function(a, b) { this.objectCount_++, this.objects_[a] = b; },
                    removeObjects: function(a, b) {
                        var c;
                        a || (a = []);
                        for (c in this.objects_) a.push({ obj: this.objects_[c], quadrant: this }), delete this.objects_[c];
                        return this.objectCount_ = 0, b && 1 !== b || this.parent_ && this.parent_.removeObjects(a, 1), b && -1 !== b || this.children_.forEach(function(b) { b.removeObjects(a, -1); }), a; },
                    ...
                    getObjectCount: function(a, b) {
                        ...
                        return a && this.children_.forEach(function(d) { c += d.getObjectCount(!b && a); }), c; },
                    intersectingChildren: function(a, b) { return this.children_.filter(function(c) { return c.intersects(a, b); }); },
                    ...
                    hasChildren: function() { return 0 !== this.getChildCount(); },
                    getChildCount: function(a) {
                        var b = this.children_.length;
                        return a && this.children_.forEach(function(c) { b += c.getChildCount(a); }), b; },
                    getChildren: function(a, b) { return b || (b = []), b.push.apply(b, this.children_), a && this.children_.forEach(function(c) { c.getChildren(a, b); }), b; },
                    ...
                    getObjectsDown: function(a) {
                        ...
                        if (!a.quadrants[this.id_]) {
                            a.quadrants[this.id_] = !0;
                            for (b in this.objects_) a.objects[b] = this.objects_[b];
                            for (b = 0; b < this.children_.length; b++) this.children_[b].getObjectsDown(a); } } }, b.exports = c; }, {} ],
            6: [ function(a, b) {
                var c = (a("vec2"), a("./quadtree2helper")), d = function() {};
                d.prototype = {
                    isNumber: function(a, b) { "number" != typeof a && c.thrower("NaN", "Not a Number", b); },
                    isString: function(a, b) { "string" == typeof a || a instanceof String || c.thrower("NaS", "Not a String", b); },
                    isVec2: function(a, b) {
                        var d = !1;
                        d = "object" != typeof a || void 0 === a.x || void 0 === a.y, d && c.thrower("NaV", "Not a Vec2", b); },
                    isDefined: function(a, b) { void 0 === a && c.thrower("ND", "Not defined", b); },
                    isObject: function(a, b) { "object" != typeof a && c.thrower("NaO", "Not an Object", b); },
                    hasKey: function(a, b, d) { this.isDefined(a, "obj"), -1 === Object.keys(a).indexOf(b.toString()) && c.thrower("OhnK", "Object has no key", d + b); },
                    hasNoKey: function(a, b, d) { this.isDefined(a, "obj"), -1 !== Object.keys(a).indexOf(b.toString()) && c.thrower("OhK", "Object has key", d + b); },
                    fnFalse: function(a) { a() && c.thrower("FarT", "function already returns true", c.fnName(a)); },
                    byCallbackObject: function(a, b, c) {
                        var d;
                        for (d in b) void 0 !== c ? b[d](a[c[d]], c[d]) : b[d](a[d], d); } }, b.exports = d; }, { "./quadtree2helper": 4, vec2: 2 } ] }, {}, [ 1 ]);
